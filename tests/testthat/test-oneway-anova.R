...
Phi <- model.oneway.anova.eta(Y, init, sigma2.epsilon, sigma2.alpha, iters = 10000)
colMeans(Phi)

Phi <- model.oneway.anova.alpha(Y, init, sigma2.epsilon, sigma2.alpha, iters = 10000)
colMeans(Phi)
